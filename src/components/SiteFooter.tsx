    ...
    <footer className="mt-24 border-t border-line">
      <div className="mx-auto grid max-w-[90rem] gap-12 px-6 py-16 sm:px-8 md:grid-cols-3">
        <div>
          ...
          <p className="mt-2 max-w-xs text-sm text-muted-fg">{site.tagline}</p>
        </div>
        ...
        <div className="min-w-0">
          ...
          <ul className="mt-6 space-y-3 text-sm">
            ...
            <li className="flex min-w-0 items-start gap-2">
              ...
              <a href={`mailto:${site.email}`} className="inline-block min-w-0 [overflow-wrap:anywhere] py-2 hover:underline">
                {site.email}
              </a>
            </li>
            <li className="flex min-w-0 items-start gap-2">
              <Phone className="mt-0.5 size-4 shrink-0 text-muted-fg" aria-hidden="true" />
              <a href={`tel:${site.phone.replace(/\s/g, "")}`} className="inline-block min-w-0 [overflow-wrap:anywhere] py-2 hover:underline">
                {site.phone}
              </a>
            </li>
            <li className="flex min-w-0 items-start gap-2">
              ...
              <a
                ...
                target="_blank"
                className="inline-block min-w-0 [overflow-wrap:anywhere] py-2 hover:underline"
              >
                Instagram
              </a>
            </li>
        ...
        <div className="min-w-0">
          ...
          <ul className="mt-6 space-y-3 text-sm">
            {nav.map((item) => (
              <li key={item.href}>
                <Link href={item.href} className="inline-block min-w-0 [overflow-wrap:anywhere] py-2 hover:underline">
                  {item.label}
                </Link>
              </li>
            ))}
      ...
      <div className="mx-auto max-w-[90rem] border-t border-line px-6 py-8 text-xs text-muted-fg sm:px-8">
