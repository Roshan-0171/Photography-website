...
export default function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-line">
      <div className="mx-auto grid max-w-[90rem] gap-12 px-6 py-8 sm:px-8 md:grid-cols-3">
        <div>
      ...
      <div className="mx-auto max-w-[90rem] border-t border-line px-6 py-4 text-xs text-muted-fg sm:px-8">
